...
- [#1](https://github.com/phamvanloi7710/hong-van/issues/1) — Provide a one-command contributor health check for Docker, database, Redis, backend, and Admin prerequisites.
- [#2](https://github.com/phamvanloi7710/hong-van/issues/2) — Reduce GitHub backend CI startup time with a reproducible prebuilt quality image or equivalent cache-safe approach.
- [#5](https://github.com/phamvanloi7710/hong-van/issues/5) — Document the public-contribution path from GitHub Pull Request to the authoritative GitLab merge.

### Public-site confidence

- [#3](https://github.com/phamvanloi7710/hong-van/issues/3) — Add a focused Playwright smoke suite for public contact and quotation journeys.
- [#4](https://github.com/phamvanloi7710/hong-van/issues/4) — Complete dynamic public routing for published Page Builder pages.
- [#6](https://github.com/phamvanloi7710/hong-van/issues/6) — Publish clearly licensed sample media so a fresh local environment can demonstrate the product without proprietary source packages.
