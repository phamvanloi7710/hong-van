...
const VI = {
  ...
  saveTemplate: 'Lưu thành template', templateLibrary: 'Thư viện template', noTemplates: 'Chưa có template.', templateKeyPrompt: 'Nhập mã template:', templateNamePrompt: 'Nhập tên template:', templateCategoryPrompt: 'Nhập nhóm template (không bắt buộc):', templateSaved: 'Đã lưu template.', templateError: 'Không thể lưu template.', export: 'Xuất JSON', exportReady: 'Đã tải file export.', exportError: 'Không thể xuất page.', validateImport: 'Kiểm tra import', importValid: 'File import hợp lệ.', importValidReport: 'Import hợp lệ: {count} tham chiếu media.', importError: 'File import không hợp lệ.', lockOwned: 'Bạn đang giữ khóa chỉnh sửa ({name}).', lockUnavailable: 'Không thể lấy khóa chỉnh sửa.', lockError: 'Khóa chỉnh sửa đã hết hạn hoặc thuộc phiên khác.', forceUnlock: 'Mở khóa', forceUnlockConfirm: 'Mở khóa chỉnh sửa của phiên khác?',
...
const EN: Record<PageBuilderTranslationKey, string> = {
  ...
  schedule: 'Schedule', schedulePrompt: 'Enter publication date and time (for example 2026-08-05 09:00):', scheduleInvalid: 'The publication date is invalid.', scheduledNotice: 'Publication scheduled.', versionHistory: 'Version history', versionNote: 'Version note:', versionSaved: 'Immutable version milestone saved.', previewVersion: 'Preview', noVersions: 'No version milestone yet.', rollback: 'Restore', rollbackConfirm: 'Restore v{version} and publish it as a new version?', rollbackNotice: 'A restored version was published.', publishConfirm: 'Publish the current draft now?', publishedNotice: 'Page published.', publishError: 'The publishing operation failed.', saveTemplate: 'Save as template', templateLibrary: 'Template library', noTemplates: 'No templates yet.', templateKeyPrompt: 'Enter template key:', templateNamePrompt: 'Enter template name:', templateCategoryPrompt: 'Enter template category (optional):', templateSaved: 'Template saved.', templateError: 'Unable to save template.', export: 'Export JSON', exportReady: 'Export file downloaded.', exportError: 'Unable to export page.', validateImport: 'Validate import', importValid: 'Import file is valid.', importValidReport: 'Import is valid: {count} media references.', importError: 'Import file is invalid.', lockOwned: 'You hold the edit lock ({name}).', lockUnavailable: 'Unable to acquire the edit lock.', lockError: 'The edit lock expired or belongs to another session.', forceUnlock: 'Force unlock', forceUnlockConfirm: 'Force release another session edit lock?',
};
...
const ZH: Record<PageBuilderTranslationKey, string> = {
  ...
  schedule: '计划发布', schedulePrompt: '请输入发布日期和时间（例如 2026-08-05 09:00）：', scheduleInvalid: '发布日期无效。', scheduledNotice: '已计划发布。', versionHistory: '版本历史', versionNote: '版本备注：', versionSaved: '已保存不可变版本里程碑。', previewVersion: '预览', noVersions: '暂无版本里程碑。', rollback: '恢复', rollbackConfirm: '恢复 v{version} 并发布为新版本？', rollbackNotice: '恢复的版本已发布。', publishConfirm: '立即发布当前草稿？', publishedNotice: '页面已发布。', publishError: '发布操作失败。', saveTemplate: '保存为模板', templateLibrary: '模板库', noTemplates: '暂无模板。', templateKeyPrompt: '输入模板编码：', templateNamePrompt: '输入模板名称：', templateCategoryPrompt: '输入模板分类（可选）：', templateSaved: '模板已保存。', templateError: '无法保存模板。', export: '导出 JSON', exportReady: '导出文件已下载。', exportError: '无法导出页面。', validateImport: '验证导入', importValid: '导入文件有效。', importValidReport: '导入有效：{count} 个媒体引用。', importError: '导入文件无效。', lockOwned: '您持有编辑锁（{name}）。', lockUnavailable: '无法获取编辑锁。', lockError: '编辑锁已过期或属于其他会话。', forceUnlock: '强制解锁', forceUnlockConfirm: '强制释放其他会话的编辑锁？',
};
