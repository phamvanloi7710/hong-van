...
| Release discipline | Pass | Semantic Versioning policy, `CHANGELOG.md`, and first public `v0.1.0` release plan. |
...
Apply now. Describe the project as an early but substantial public project, emphasize the maintainer workflow and six-month OSS plan, and disclose the current adoption level. Reassess adoption monthly using organic stars, forks, issues, Pull Requests, releases, and distinct contributors. Do not treat maintainer-created issues, CI runs, or release downloads as external adoption.
