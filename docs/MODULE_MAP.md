...
| Showcase | galleries/items, partners, certifications, projects/translations/media | Company profile, gallery, partners, certifications and project/case-study pages | `/admin/galleries`, `/admin/partners`, `/admin/certifications`, `/admin/projects` | `galleries.*`, `partners.*`, `certifications.*`, `projects.*` | Media, SEO, Audit |
