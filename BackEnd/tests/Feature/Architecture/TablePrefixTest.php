...
class TablePrefixTest extends TestCase
{
    ...
    public function test_mysql_schema_contains_only_prefixed_tables(): void
    {
        ...
        $expectedTables = [
            ...
            'hongvan_lead_contact_details',
            'hongvan_lead_notes',
            'hongvan_lead_quote_items',
            'hongvan_lead_request_links',
            ...
            'hongvan_post_slug_histories',
            'hongvan_post_tag_links',
            'hongvan_post_tag_translations',
            'hongvan_post_tags',
