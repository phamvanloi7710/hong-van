...
return [
    ...
    'validation' => [
        ...
        'unknown_field' => 'This field is not allowlisted.', 'type' => 'The value type is invalid.', 'enum' => 'The value is not allowlisted.', 'max_length' => 'The string exceeds the allowed length.', 'pattern' => 'The value format is invalid.',
        'mobile_grid_columns' => 'The mobile grid allows only one or two columns.', 'background_media_required' => 'A valid media public ID is required for a media background.',
        'columns_children' => 'This columns preset requires exactly :count children.',
        'min_length' => 'The string is shorter than allowed.', 'items_min' => 'The list has fewer items than allowed.', 'items_max' => 'The list has more items than allowed.',
        'multiple_h1' => 'A PageDocument can contain at most one level-one heading.', 'content_required' => 'Content is required.',
        'accessible_label_required' => 'An accessible label is required.', 'alt_required' => 'Alternative text is required unless the image is decorative.',
        'unsafe_url' => 'The URL protocol or format is not allowed.', 'link_pair' => 'Link URL and link label must be provided together.',
