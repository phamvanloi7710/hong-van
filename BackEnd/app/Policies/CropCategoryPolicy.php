...
final readonly class CropCategoryPolicy
{
    ...
    public function update(User $actor, CropCategory $category): bool
    {
        return $this->permissions->allows($actor, 'crops.update');
    }

    public function delete(User $actor, CropCategory $category): bool
    {
