...
final class StoreTransportRequest extends FormRequest
{
    ...
    {
        return ['pickup_location' => ['required', 'string', 'max:255'], 'delivery_location' => ['required', 'string', 'max:255'], 'cargo_description' => ['required', 'string', 'max:5000'], 'cargo_weight' => ['nullable', 'numeric', 'min:0'], 'weight_unit' => ['nullable', Rule::in(['kg', 'ton'])], 'vehicle_type_id' => ['nullable', 'string', 'size:26', 'exists:hongvan_vehicle_types,public_id'], 'requested_date' => ['nullable', 'date', 'after_or_equal:today'], 'contact_name' => ['required', 'string', 'max:255'], 'contact_phone' => ['required', 'string', 'max:32'], 'contact_email' => ['nullable', 'email:rfc', 'max:255']];
    }
}
