...
use App\Policies\PostTaxonomyPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(PostCategory::class, PostTaxonomyPolicy::class);
        Gate::policy(PostTag::class, PostTaxonomyPolicy::class);
        Gate::policy(Gallery::class, ShowcasePolicy::class);
        Gate::policy(GalleryItem::class, ShowcasePolicy::class);
        Gate::policy(Partner::class, ShowcasePolicy::class);
        Gate::policy(Certification::class, ShowcasePolicy::class);
        Gate::policy(Project::class, ShowcasePolicy::class);
