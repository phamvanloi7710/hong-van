...
final class WarehouseService extends TranslatableModel
{
    use HasPublicId;

    protected $table = 'hongvan_warehouse_services';

    public static function translationModelClass(): string
    {
        return WarehouseServiceTranslation::class;
    }

    public static function translationForeignKey(): string
    {
        return 'warehouse_service_id';
    }
    ...
    {
        return $this->belongsToMany(Warehouse::class, 'hongvan_warehouse_service_assignments')->withPivot(['sort_order', 'created_at']);
    }
