 ...
 */
#[Fillable(['page_id', 'version_number', 'status', 'schema_version', 'document_json', 'checksum', 'note', 'parent_version_id', 'created_by', 'published_by', 'published_at'])]
final class PageVersion extends Model
{
    ...
    protected static function booted(): void
    {
        self::updating(function (self $version): void {
            ...
            if ($version->getOriginal('status') !== 'draft' && $version->isDirty(['schema_version', 'document_json', 'checksum'])) {
                throw new LogicException('Saved Page Builder version content is immutable.');
            }
        });
