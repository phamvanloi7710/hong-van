...
return [
    ...
    'usage_owner_types' => ['product', 'page', 'post', 'settings', 'seo_meta', 'crop_category', 'crop', 'crop_stage', 'crop_solution', 'service', 'vehicle', 'warehouse', 'gallery_item', 'partner', 'certification', 'project'],
];
