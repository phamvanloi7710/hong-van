...
use App\Http\Controllers\Api\V1\PageBuilder\PageLockController;
use App\Http\Controllers\Api\V1\PageBuilder\PageTemplateController;
    ...
    ->group(function (): void {
        ...
        Route::middleware('auth:sanctum')->group(function (): void {
            ...
            Route::prefix('page-builder')->name('page-builder.')->group(function (): void {
                ...
                Route::get('templates', [PageTemplateController::class, 'index'])->middleware('permission:pages.view')->name('templates.index');
                Route::post('pages/{page:public_id}/templates', [PageTemplateController::class, 'store'])->middleware('permission:pages.update')->name('templates.store');
                Route::post('templates/{template:public_id}/pages', [PageTemplateController::class, 'createPage'])->middleware('permission:pages.create')->name('templates.pages.store');
                Route::post('pages/{page:public_id}/duplicate', [PageTemplateController::class, 'duplicate'])->middleware('permission:pages.create')->name('pages.duplicate');
                Route::get('pages/{page:public_id}/export', [PageTemplateController::class, 'export'])->middleware('permission:pages.export')->name('pages.export');
                Route::post('imports/validate', [PageTemplateController::class, 'validateImport'])->middleware('permission:pages.import')->name('imports.validate');
                Route::post('imports', [PageTemplateController::class, 'import'])->middleware('permission:pages.import')->name('imports.store');
                Route::get('pages/{page:public_id}/lock', [PageLockController::class, 'show'])->middleware('permission:pages.view')->name('pages.lock.show');
                Route::post('pages/{page:public_id}/lock', [PageLockController::class, 'acquire'])->middleware('permission:pages.update')->name('pages.lock.acquire');
                Route::put('pages/{page:public_id}/lock', [PageLockController::class, 'heartbeat'])->middleware('permission:pages.update')->name('pages.lock.heartbeat');
                Route::delete('pages/{page:public_id}/lock', [PageLockController::class, 'release'])->middleware('permission:pages.update')->name('pages.lock.release');
                Route::delete('pages/{page:public_id}/lock/force', [PageLockController::class, 'forceRelease'])->middleware('permission:pages.force_unlock')->name('pages.lock.force-release');
